...
<div class="content">
    <div class="card-body table-responsive" style="padding-top: 0">
        <a class="btn btn-outline-primary btn-table-tool btn-dialog" data-intop="1" data-area="50%,70%" title="新增" href="?app=tag@add"><i class="fa fa-plus"></i>新增</a>
    </div>
    <div class="card-body table-responsive" style="padding-top: 0">
        <table data-table="1" data-url="?app=tag@ajax_data" id="table1" class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th data-formatter="epiiFormatter.btns" data-intop="1" data-area="50%,70%" data-btns="edit,del" data-edit-url="?app=tag@add&id={id}" data-edit-title="编辑" data-del-url="?app=tag@del&id={id}" data-del-title="删除">操作
                    </th>
                </tr>
            </thead>
        </table>
