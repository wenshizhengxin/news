...
-- ----------------------------
-- Table structure for epii_news_article
-- ----------------------------
CREATE TABLE IF NOT EXISTS `epii_news_article`  (
  ...
  `tag_names` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '所有标签名称（多个之间以“,”号隔开）',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '状态：0-未开启；1-已开启',
  `top` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否置顶：0-不置顶；1-置顶',
  `sort` int(10) UNSIGNED NOT NULL DEFAULT 10000 COMMENT '排序（数字越小越靠前）',
...
-- ----------------------------
-- Table structure for epii_news_classify
-- ----------------------------
CREATE TABLE IF NOT EXISTS `epii_news_classify`  (
  ...
  `x_prop1` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '扩展属性1',
  `x_prop2` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '扩展属性2',
...
-- ----------------------------
-- Table structure for epii_news_tag
-- ----------------------------
CREATE TABLE IF NOT EXISTS `epii_news_tag`  (
